...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(filtered_df, values='class', names='Launch Site', title='Success for all sites')
        ...
        fig = px.pie(grouped_df, values='class count', names='class',
            title='Succes vs Failure (%s)' % entered_site)
...
def get_scatter(site_dropdown, slider_range):
    ...
    if site_dropdown != 'ALL':
        ...
        scatter_fig = px.scatter(filtered_df, x = 'Payload Mass (kg)', y = 'class', 
                            ...
                            title='Correlation between payload and success (%s)' % site_dropdown)
    return scatter_fig
